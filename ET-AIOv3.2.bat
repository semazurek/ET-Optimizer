...
REM - StevenBlack/hosts blocklist - ads blocking via hosts file (AdAway, Adguard, KADhosts, URLHaus)
echo Setting Ad blocking via hosts file
PowerShell -Command "wget https://raw.githubusercontent.com/StevenBlack/hosts/master/hosts -o hosts"
